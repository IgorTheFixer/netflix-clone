    ...
    ">
      ...
      <div className="
        ...
        <div className="flex flex-row items-center gap-3">
          ...
          <div onClick={()=> openModal(data?.id)} className="cursor-pointer ml-auto group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center items-center transtion hover:border-neutral-300">
